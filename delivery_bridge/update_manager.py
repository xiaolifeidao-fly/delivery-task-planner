...
class PluginUpdateManager:
    ...
    def _validate_package(root: Path, expected_version: str) -> None:
        required = [
            ...
            root / "delivery_bridge" / "turn_view.py",
            ...
            root / "delivery_bridge" / "stores.py",
            root / "delivery_bridge" / "chat_archive.py",
            root / "delivery_bridge" / "artifacts.py",
            root / "delivery_bridge" / "sessions.py",
            root / "delivery_bridge" / "progress_events.py",
            root / "delivery_bridge" / "item_keys.py",
            root / "delivery_bridge" / "executor_env.py",
            ...
            root / "delivery_bridge" / "execution" / "core.py",
            root / "delivery_bridge" / "execution" / "sync.py",
            root / "delivery_bridge" / "execution" / "naming.py",
            root / "delivery_bridge" / "execution" / "planning.py",
            root / "delivery_bridge" / "execution" / "environment.py",
            root / "delivery_bridge" / "execution" / "requirement_testing.py",
            root / "delivery_bridge" / "execution" / "requirement_review.py",
            root / "delivery_bridge" / "execution" / "fine_tuning.py",
            root / "delivery_bridge" / "execution" / "task_testing.py",
            root / "delivery_bridge" / "execution" / "git.py",
            root / "delivery_bridge" / "execution" / "queue.py",
            root / "delivery_bridge" / "execution" / "conversation.py",
            root / "delivery_bridge" / "execution" / "documents.py",
            root / "delivery_bridge" / "execution" / "prototype.py",
            root / "delivery_bridge" / "execution" / "turns.py",
        ]
